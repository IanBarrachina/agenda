class TiposController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo.save
        format.html { redirect_to @tipo, notice: 'Se ha creado el tipo correctamente.' }
  ...
  def update
    respond_to do |format|
      if @tipo.update(tipo_params)
        format.html { redirect_to @tipo, notice: 'Se ha actualizado el tipo correctamente.' }
  ...
  def destroy
    @tipo.destroy
    respond_to do |format|
      format.html { redirect_to tipos_url, notice: 'Se ha eliminado el tipo correctamente.' }
